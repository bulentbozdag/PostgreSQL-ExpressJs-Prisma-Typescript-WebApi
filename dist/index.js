...
app.get("/", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        res.send(getStandardResponse(true, "succ", "Ok"));
        return [2 /*return*/];
    });
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                allUsers = _a.sent();
                res.setHeader('Content-Type', 'application/json');
                res.send(getStandardResponse(true, "succ", allUsers));
                return [2 /*return*/];
        }
    });
}); });
app.post("/adduser", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, addUser(req.body)];
            case 1:
                _a.sent();
...
function addUser(model) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.user.create(model)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
